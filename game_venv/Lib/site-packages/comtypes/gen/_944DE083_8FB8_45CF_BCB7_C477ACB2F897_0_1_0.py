...
__all__ = [
    'UIA_MarginTopAttributeId', 'ExtendedProperty',
    'UIA_LevelPropertyId', 'UIA_StylesPatternId',
    'NavigateDirection_NextSibling', 'ScrollAmount_LargeIncrement',
    'StyleId_Subtitle', 'AnnotationType_Footer',
    'UIA_IsRangeValuePatternAvailablePropertyId',
    'IUIAutomationElement9', 'DockPosition', 'UIA_TreeControlTypeId',
    'UIA_LegacyIAccessibleNamePropertyId',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'UIA_FillTypePropertyId', 'IUIAutomationExpandCollapsePattern',
    'IUIAutomationTextChildPattern', 'IUIAutomationElement2',
    'UIA_ClickablePointPropertyId', 'UIA_ComboBoxControlTypeId',
    'UIA_SpreadsheetItemPatternId', 'UIA_SelectionPattern2Id',
    'UIA_IsScrollPatternAvailablePropertyId', 'HeadingLevel9',
    'UIA_UnderlineColorAttributeId', 'UIA_AnnotationPatternId',
    'NotificationProcessing_CurrentThenMostRecent',
    'UIA_MenuModeEndEventId', 'UIA_CustomControlTypeId',
    'UIA_NativeWindowHandlePropertyId', 'IUIAutomationInvokePattern',
    'SynchronizedInputType_KeyDown', 'WindowVisualState',
    'UIA_CaretPositionAttributeId', 'IUIAutomationRangeValuePattern',
    'UIA_AutomationIdPropertyId', 'UIA_StyleNameAttributeId',
    'UIA_DataGridControlTypeId', 'UIA_Transform2CanZoomPropertyId',
    'PropertyConditionFlags', 'ExpandCollapseState_Expanded',
    'UIA_WindowWindowVisualStatePropertyId',
    'UIA_IsTransformPattern2AvailablePropertyId',
    'UIA_TitleBarControlTypeId', 'TextUnit',
    'UIA_IsEnabledPropertyId', 'UIA_DocumentControlTypeId',
    'ZoomUnit_NoAmount', 'UIA_IsDataValidForFormPropertyId',
    'UIA_ScrollVerticalViewSizePropertyId',
    'UIA_Selection2FirstSelectedItemPropertyId',
    'IUIAutomationTreeWalker', 'IUIAutomation2',
    'UIA_SizeOfSetPropertyId', 'AnnotationType_Unknown',
    'NotificationProcessing_ImportantMostRecent',
    'ScrollAmount_SmallDecrement', 'UIA_WindowIsTopmostPropertyId',
    'UIA_HeaderItemControlTypeId',
    'UIA_LocalizedLandmarkTypePropertyId',
    'UIA_SplitButtonControlTypeId',
    'ProviderOptions_ClientSideProvider',
    'UIA_DragIsGrabbedPropertyId', 'IUIAutomationNotCondition',
    'UIA_CheckBoxControlTypeId', 'IUIAutomationTablePattern',
    'UIA_SelectionSelectionPropertyId', 'NavigateDirection_LastChild',
    'UIA_RangeValueMaximumPropertyId', 'OrientationType_None',
    'TextPatternRangeEndpoint_End', 'IUIAutomationPropertyCondition',
    'UIA_MenuModeStartEventId', 'StyleId_Heading1',
    'IUIAutomationLegacyIAccessiblePattern',
    'UIA_SliderControlTypeId', 'IUIAutomationDropTargetPattern',
    'WindowInteractionState_Closing',
    'SynchronizedInputType_LeftMouseDown', 'UIA_TogglePatternId',
    'UIA_ValueValuePropertyId', 'IUIAutomationTransformPattern',
    'UIA_Selection2LastSelectedItemPropertyId', 'UIA_NamePropertyId',
    'NotificationKind_ActionCompleted', 'SupportedTextSelection_None',
    'UIA_LegacyIAccessibleRolePropertyId', 'UIA_ScrollItemPatternId',
    'ExpandCollapseState', 'UIA_TableItemPatternId',
    'IUIAutomationGridItemPattern', 'UIA_MenuItemControlTypeId',
    'UIA_IsItalicAttributeId', 'SupportedTextSelection_Multiple',
    'UIA_ThumbControlTypeId',
    'UIA_IsAnnotationPatternAvailablePropertyId',
    'UIA_SemanticZoomControlTypeId', 'NotificationProcessing',
    'UIA_Selection2ItemCountPropertyId',
    'UIA_IsGridPatternAvailablePropertyId',
    'UIA_IsTogglePatternAvailablePropertyId',
    'UIA_GridItemRowSpanPropertyId', 'CoalesceEventsOptions_Enabled',
    'TextUnit_Character', 'TextEditChangeType',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'TreeScope_Ancestors', 'UIA_TablePatternId',
    ...
    'IUIAutomationSynchronizedInputPattern', 'DockPosition_Top',
    'IUIAutomationSelectionPattern2', 'UIA_Text_TextChangedEventId',
    'AnnotationType_MoveChange', 'HeadingLevel4',
    'UIA_DropTarget_DroppedEventId',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'UIA_MenuClosedEventId', 'UIA_IsTextPatternAvailablePropertyId',
    'IUIAutomationEventHandler', 'AnnotationType_Footnote',
    'UIA_IsRequiredForFormPropertyId', 'Polite', 'UIA_TextPattern2Id',
    'StructureChangeType_ChildrenInvalidated',
    'UIA_SeparatorControlTypeId', 'ToggleState_Indeterminate',
    'UIA_IsPasswordPropertyId', 'TreeScope_Element',
    'UIA_Invoke_InvokedEventId', 'Off', 'DockPosition_None',
    'UIA_SelectionItemIsSelectedPropertyId',
    'UIA_IsTableItemPatternAvailablePropertyId',
    'UIA_ExpandCollapsePatternId', 'UIA_GridItemRowPropertyId',
    'UIA_NavigationLandmarkTypeId', 'IUIAutomationElement',
    'UIA_MarginLeadingAttributeId', 'CoalesceEventsOptions_Disabled',
    'ProviderOptions_ServerSideProvider', 'ScrollAmount',
    'UIA_DragPatternId', 'UIA_GridRowCountPropertyId',
    'UIA_ControlTypePropertyId', 'UIA_AnnotationTypesAttributeId',
    'StyleId_Title', 'UIA_GridPatternId',
    'UIA_IsInvokePatternAvailablePropertyId', 'IUIAutomation5',
    'LiveSetting', 'UIA_MarginBottomAttributeId',
    'UIA_WindowPatternId', 'UIA_TableItemColumnHeaderItemsPropertyId',
    'UIA_LegacyIAccessiblePatternId',
    'UIA_ScrollHorizontallyScrollablePropertyId',
    'UIA_TableItemRowHeaderItemsPropertyId',
    'UIA_StrikethroughColorAttributeId', 'SynchronizedInputType',
    'IUIAutomationScrollItemPattern', 'NotificationKind_ItemAdded',
    'IRawElementProviderSimple', 'UIA_Selection_InvalidatedEventId',
    'IUIAutomation4', 'AnnotationType_InsertionChange',
    'IUIAutomationSpreadsheetItemPattern', 'UIA_ToolBarControlTypeId',
    'UIA_IsStylesPatternAvailablePropertyId',
    'WindowInteractionState_Running', 'UIA_TableControlTypeId',
    'ProviderOptions_UseComThreading', 'UIA_GroupControlTypeId',
    'UIA_ValuePatternId', 'IUIAutomationBoolCondition',
    'UIA_IsPeripheralPropertyId', 'UIA_ProgressBarControlTypeId',
    'IUIAutomationItemContainerPattern',
    'IUIAutomationSelectionItemPattern', 'UIA_IsReadOnlyAttributeId',
    'IUIAutomationChangesEventHandler', 'CUIAutomation8',
    'IUIAutomationTableItemPattern',
    'UIA_Transform2ZoomLevelPropertyId',
    'TreeTraversalOptions_Default', 'UIA_SpinnerControlTypeId',
    'UIA_IsTextPattern2AvailablePropertyId', 'StyleId_Heading3',
    'UIA_ListControlTypeId', 'UIA_LineSpacingAttributeId',
    'ToggleState_Off', 'UIA_ToggleToggleStatePropertyId',
    'IUIAutomationCacheRequest', 'UIA_CustomLandmarkTypeId',
    'UIA_IsObjectModelPatternAvailablePropertyId',
    'IUIAutomationStylesPattern', 'TreeScope_None',
    'ZoomUnit_LargeDecrement', 'UIA_DataItemControlTypeId',
    'UIA_TransformCanMovePropertyId', 'UIA_CalendarControlTypeId',
    'StructureChangeType_ChildAdded', 'UIA_TextPatternId',
    'UIA_ListItemControlTypeId', 'UIA_RangeValuePatternId',
    'IUIAutomationProxyFactoryEntry', 'UIA_InputDiscardedEventId',
    'IUIAutomationActiveTextPositionChangedEventHandler',
    'UIA_SpreadsheetPatternId', 'IUIAutomation3',
    'UIA_OutlineColorPropertyId', 'WindowVisualState_Normal',
    'TextUnit_Word', 'WindowInteractionState_BlockedByModalWindow',
    'UIA_IsSpreadsheetItemPatternAvailablePropertyId',
    'UIA_ScrollHorizontalScrollPercentPropertyId',
    'UIA_LocalizedControlTypePropertyId',
    'UIA_SayAsInterpretAsAttributeId',
    'UIA_RangeValueIsReadOnlyPropertyId', 'UIA_RotationPropertyId',
    'TextEditChangeType_None',
    'ConnectionRecoveryBehaviorOptions_Disabled',
    'IUIAutomationStructureChangedEventHandler',
    'UIA_LegacyIAccessibleDescriptionPropertyId',
    'IUIAutomationWindowPattern', 'UIA_StylesStyleNamePropertyId',
    'UIA_ProcessIdPropertyId',
    'UIA_IsSelectionPattern2AvailablePropertyId',
    'UIA_LegacyIAccessibleHelpPropertyId', 'IUIAutomationDragPattern',
    'UIA_EditControlTypeId', 'IUIAutomationEventHandlerGroup',
    'UIA_AnimationStyleAttributeId',
    'UIA_IsSelectionPatternAvailablePropertyId',
    'UIA_ImageControlTypeId', 'UIA_RuntimeIdPropertyId',
    'IUIAutomationCondition', 'UIA_IsTablePatternAvailablePropertyId',
    ...
    'IUIAutomationVirtualizedItemPattern', 'UIA_MenuControlTypeId',
    'IUIAutomation6', 'UIA_HorizontalTextAlignmentAttributeId',
    'HeadingLevel1', 'UIA_IsMultipleViewPatternAvailablePropertyId',
    'AnnotationType_Highlighted', 'HeadingLevel7',
    'StyleId_BulletedList',
    'UIA_IsTransformPatternAvailablePropertyId',
    'UIA_IsDropTargetPatternAvailablePropertyId', 'HeadingLevel3',
    'UIA_HasKeyboardFocusPropertyId', 'StyleId_NumberedList',
    'UIA_InputReachedTargetEventId', 'UIA_ToolTipClosedEventId',
    'TextEditChangeType_Composition',
    'UIA_DropTarget_DragLeaveEventId',
    'UIA_RangeValueValuePropertyId', 'UIA_BackgroundColorAttributeId',
    'UIA_SearchLandmarkTypeId', 'UIA_WindowCanMinimizePropertyId',
    'StyleId_Normal', 'UIA_AfterParagraphSpacingAttributeId',
    'UIA_LinkAttributeId', 'UIA_ScrollHorizontalViewSizePropertyId',
    'IUIAutomationTextEditPattern', 'AnnotationType_UnsyncedChange',
    'UIA_FontSizeAttributeId', 'UIA_SpreadsheetItemFormulaPropertyId',
    'SynchronizedInputType_LeftMouseUp', 'UIA_IsActiveAttributeId',
    'IUIAutomationTextEditTextChangedEventHandler',
    'IUIAutomationSpreadsheetPattern',
    'UIA_SelectionActiveEndAttributeId', 'UIA_HeadingLevelPropertyId',
    'StyleId_Heading6', 'UIA_FullDescriptionPropertyId',
    'WindowInteractionState', 'NotificationKind_Other',
    'AnnotationType_Sensitive', 'UIA_GridItemColumnSpanPropertyId',
    'UIA_TransformCanResizePropertyId', 'UIA_IsHiddenAttributeId',
    'AnnotationType_ConflictingChange', 'CUIAutomation',
    'TextPatternRangeEndpoint_Start', 'StyleId_Heading8',
    'IUIAutomationTextPattern', 'UIA_BoundingRectanglePropertyId',
    'UIA_IsWindowPatternAvailablePropertyId', 'TreeScope_Subtree',
    'UIA_WindowCanMaximizePropertyId',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'NavigateDirection_FirstChild', 'StyleId_Quote',
    'UIA_StylesFillPatternColorPropertyId', 'DockPosition_Bottom',
    'UIA_OverlineColorAttributeId', 'UIA_Drag_DragCompleteEventId',
    'NotificationProcessing_MostRecent', 'IUIAutomationElement5',
    'TextUnit_Format', 'TextEditChangeType_AutoCorrect',
    'AnnotationType_Comment', 'StructureChangeType_ChildrenReordered',
    'UIA_VisualEffectsPropertyId', 'UIA_MarginTrailingAttributeId',
    'UIA_IsItemContainerPatternAvailablePropertyId',
    'UIA_FillColorPropertyId', 'UIA_AriaRolePropertyId',
    'AutomationElementMode', 'AnnotationType_FormatChange',
    'OrientationType_Vertical', 'UIA_TableRowHeadersPropertyId',
    'UIA_SpreadsheetItemAnnotationObjectsPropertyId',
    'RowOrColumnMajor_RowMajor',
    'UIA_MultipleViewSupportedViewsPropertyId', 'ProviderOptions',
    'UiaChangeInfo', 'UIA_DockDockPositionPropertyId',
    'UIA_AnnotationAuthorPropertyId', 'HeadingLevel2',
    'UIA_SizePropertyId', 'UIA_RangeValueMinimumPropertyId',
    'UIA_IndentationTrailingAttributeId',
    'PropertyConditionFlags_MatchSubstring', 'HeadingLevel5',
    ...
    'UIA_FontWeightAttributeId', 'UIA_LabeledByPropertyId',
    'UIA_IsContentElementPropertyId',
    'ConnectionRecoveryBehaviorOptions_Enabled',
    'UIA_CultureAttributeId', 'ToggleState',
    'UIA_IsCustomNavigationPatternAvailablePropertyId',
    'StyleId_Custom', 'UIA_HostedFragmentRootsInvalidatedEventId',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'UIA_IsValuePatternAvailablePropertyId',
    'UIA_WindowControlTypeId',
    'UIA_SelectionCanSelectMultiplePropertyId', 'RowOrColumnMajor',
    'ExpandCollapseState_Collapsed', 'AnnotationType_ExternalChange',
    'IUIAutomationNotificationEventHandler',
    'PropertyConditionFlags_IgnoreCase', 'TextUnit_Paragraph',
    'UIA_StatusBarControlTypeId', 'IUIAutomationGridPattern',
    'UIA_ObjectModelPatternId',
    'UIA_IsScrollItemPatternAvailablePropertyId',
    'UIA_IsControlElementPropertyId', 'UIA_ScrollBarControlTypeId',
    'UIA_ChangesEventId', 'RowOrColumnMajor_ColumnMajor',
    'SynchronizedInputType_KeyUp', 'StyleId_Emphasis',
    'UIA_HyperlinkControlTypeId',
    'WindowInteractionState_ReadyForUserInteraction',
    'NotificationKind', 'TextUnit_Document',
    'UIA_FrameworkIdPropertyId', 'IUIAutomationElement3',
    'IUIAutomation', 'UIA_AcceleratorKeyPropertyId',
    ...
    'IUIAutomationObjectModelPattern', 'TextUnit_Line', 'TreeScope',
    'UIA_MainLandmarkTypeId', 'IUIAutomationScrollPattern',
    'UIA_LegacyIAccessibleSelectionPropertyId',
    'IUIAutomationElement7', 'IUIAutomationOrCondition',
    'UIA_TreeItemControlTypeId', 'WindowVisualState_Minimized',
    'WindowVisualState_Maximized', 'UIA_PositionInSetPropertyId',
    'UIA_ClassNamePropertyId', 'UIA_WindowIsModalPropertyId',
    'IUIAutomationDockPattern',
    'UIA_StylesFillPatternStylePropertyId', 'UIA_PaneControlTypeId',
    'UIA_TextChildPatternId', 'ZoomUnit_SmallIncrement',
    'UIA_InvokePatternId', 'UIA_OutlineStylesAttributeId',
    'UIA_TextEditPatternId', 'UIA_ButtonControlTypeId',
    'UIA_LegacyIAccessibleChildIdPropertyId',
    'UIA_IsTextEditPatternAvailablePropertyId',
    'UIA_RadioButtonControlTypeId', 'UIA_FlowsToPropertyId',
    'TreeScope_Descendants', 'ZoomUnit',
    'ExpandCollapseState_PartiallyExpanded',
    'TextEditChangeType_CompositionFinalized',
    'UIA_StrikethroughStyleAttributeId', 'ToggleState_On',
    'UIA_AnnotationObjectsPropertyId', 'UIA_TransformPatternId',
    'UIA_HelpTextPropertyId', 'AnnotationType_SpellingError',
    'HeadingLevel8', 'UIA_AppBarControlTypeId',
    'UIA_CaretBidiModeAttributeId', 'UIA_Window_WindowOpenedEventId',
    'UIA_AutomationPropertyChangedEventId', 'UIA_CulturePropertyId',
    'UIA_SelectionIsSelectionRequiredPropertyId',
    'UIA_Text_TextSelectionChangedEventId', 'IUIAutomationTextRange3',
    'AnnotationType_Mathematics', 'IAccessible',
    'UIA_MultipleViewCurrentViewPropertyId',
    'UIA_Transform2ZoomMaximumPropertyId', 'UIA_CapStyleAttributeId',
    'UIA_ScrollVerticalScrollPercentPropertyId',
    'UIA_AnnotationAnnotationTypeNamePropertyId',
    'UIA_StyleIdAttributeId', 'IUIAutomationCustomNavigationPattern',
    'UIA_SummaryChangeId', 'UIA_RangeValueSmallChangePropertyId',
    'StyleId_Heading4', 'WindowInteractionState_NotResponding',
    'UIA_UnderlineStyleAttributeId', 'ScrollAmount_NoAmount',
    'UIA_ScrollPatternId', 'UIA_IsSuperscriptAttributeId',
    'OrientationType', 'DockPosition_Fill', 'DockPosition_Left',
    'IUIAutomationTextPattern2',
    'UIA_GridItemContainingGridPropertyId',
    'UIA_TransformCanRotatePropertyId',
    'UIA_ForegroundColorAttributeId',
    'AnnotationType_CircularReferenceError',
    'UIA_ValueIsReadOnlyPropertyId', 'StructureChangeType',
    'ProviderOptions_OverrideProvider',
    'StructureChangeType_ChildRemoved', 'UIA_IsDialogPropertyId',
    'UIA_MenuBarControlTypeId', 'UIA_AnnotationTargetPropertyId',
    'UIA_IsGridItemPatternAvailablePropertyId',
    'UIA_IsDragPatternAvailablePropertyId', 'UIA_SelectionPatternId',
    'TreeScope_Parent', 'UIA_ControllerForPropertyId',
    'UIA_ProviderDescriptionPropertyId', 'AutomationElementMode_Full',
    'UIA_GridItemPatternId', 'HeadingLevel_None',
    'UIA_Window_WindowClosedEventId',
    'UIA_InputReachedOtherElementEventId',
    'UIA_OverlineStyleAttributeId',
    'UIA_IsSelectionItemPatternAvailablePropertyId',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'UIA_AnnotationDateTimePropertyId', 'IUIAutomationTextRange',
    'UIA_FormLandmarkTypeId', 'IUIAutomationElement6',
    'UIA_ItemContainerPatternId', 'UIA_BulletStyleAttributeId',
    ...
    'ProviderOptions_NonClientAreaProvider', 'CoalesceEventsOptions',
    'UIA_ActiveTextPositionChangedEventId',
    'NotificationProcessing_ImportantAll',
    'TextEditChangeType_AutoComplete', 'AnnotationType_Endnote',
    'UIA_FlowsFromPropertyId', 'StyleId_Heading2',
    'NotificationKind_ActionAborted', 'Assertive',
    'UIA_ToolTipOpenedEventId', 'StyleId_Heading9',
    'UIA_StructureChangedEventId',
    'UIA_TextFlowDirectionsAttributeId',
    'UIA_AsyncContentLoadedEventId',
    'UIA_TextEdit_ConversionTargetChangedEventId',
    'IUIAutomationProxyFactory', 'ScrollAmount_LargeDecrement',
    'TreeScope_Children', 'UIA_AccessKeyPropertyId',
    'UIA_AnnotationAnnotationTypeIdPropertyId',
    'UIA_Drag_DragStartEventId', 'NavigateDirection_Parent',
    'ProviderOptions_RefuseNonClientSupport',
    'UIA_LiveSettingPropertyId', 'NavigateDirection_PreviousSibling',
    'AnnotationType_TrackChanges',
    'ConnectionRecoveryBehaviorOptions', 'UIA_SystemAlertEventId',
    'UIA_TextEdit_TextChangedEventId', 'TextPatternRangeEndpoint',
    'AnnotationType_GrammarError', 'UIA_DockPatternId',
    'AnnotationType_DeletionChange',
    'UIA_AnnotationObjectsAttributeId', 'IUIAutomationTogglePattern',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'UIA_TextControlTypeId', 'UIA_DescribedByPropertyId',
    'UIA_Drag_DragCancelEventId', 'ScrollAmount_SmallIncrement',
    'NavigateDirection', 'IUIAutomationElement4',
    'UIA_MultipleViewPatternId', 'IUIAutomationAnnotationPattern',
    'UIA_NotificationEventId', 'DockPosition_Right',
    'SupportedTextSelection_Single',
    'AnnotationType_AdvancedProofingIssue', 'ZoomUnit_SmallDecrement',
    'StyleId_Heading5', 'AnnotationType_Header',
    'UIA_TableColumnHeadersPropertyId', 'IUIAutomationTextRangeArray',
    'ExpandCollapseState_LeafNode',
    'UIA_IndentationLeadingAttributeId', 'SupportedTextSelection',
    'UIA_LegacyIAccessibleValuePropertyId', 'IUIAutomationTextRange2',
    'StructureChangeType_ChildrenBulkAdded',
    'UIA_TabItemControlTypeId', 'UIA_CustomNavigationPatternId',
    'UIA_SelectionItemSelectionContainerPropertyId',
    'IUIAutomationProxyFactoryMapping', 'UIA_CenterPointPropertyId',
    'IUIAutomationAndCondition', 'IUIAutomationTransformPattern2',
    ...
    'ZoomUnit_LargeIncrement', 'UIA_GridColumnCountPropertyId',
    'UIA_AnnotationTypesPropertyId', 'TreeTraversalOptions_PostOrder',
    'UIA_LayoutInvalidatedEventId',
    'ProviderOptions_HasNativeIAccessible',
    'UIA_DragGrabbedItemsPropertyId', 'OrientationType_Horizontal',
    'UIA_HeaderControlTypeId', 'IUIAutomationValuePattern',
    'UIA_TransformPattern2Id', 'UIA_IsKeyboardFocusablePropertyId',
    'IUIAutomationSelectionPattern', 'UIA_DropTargetPatternId',
    'IUIAutomationElement8', 'UIA_LandmarkTypePropertyId',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'IUIAutomationFocusChangedEventHandler', 'StyleId_Heading7',
    'UIA_IsOffscreenPropertyId', 'IUIAutomationElementArray',
    'UIA_TabsAttributeId', 'UIA_SelectionItem_ElementSelectedEventId',
    'NotificationProcessing_All', 'UIA_SelectionItemPatternId',
    'UIA_SayAsInterpretAsMetadataId',
    'IUIAutomationMultipleViewPattern',
    'NotificationKind_ItemRemoved', 'UIA_SynchronizedInputPatternId',
    'UIA_FontNameAttributeId', 'UIA_AriaPropertiesPropertyId',
    'UIA_StylesShapePropertyId', 'UIA_LiveRegionChangedEventId',
    'HeadingLevel6', 'UIA_IsTextChildPatternAvailablePropertyId',
    'AnnotationType_FormulaError',
    'AnnotationType_EditingLockedChange',
    'SynchronizedInputType_RightMouseDown',
    'UIA_IsSubscriptAttributeId', 'UIA_ToolTipControlTypeId',
    'UIA_TabControlTypeId', 'UIA_ItemStatusPropertyId',
    'ProviderOptions_ProviderOwnsSetFocus', 'TextUnit_Page',
    'TreeTraversalOptions', 'UIA_ItemTypePropertyId',
    'PropertyConditionFlags_None', 'UIA_MenuOpenedEventId',
    'UIA_DropTargetDropTargetEffectsPropertyId',
    'UIA_OrientationPropertyId', 'UIA_DragDropEffectPropertyId'
]

_check_version('1.1.14', 1681446928.615181)
